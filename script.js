...
const pop = () => {
  ...
  const random = Math.floor(Math.random() * idea_arr.length);
  document
    .getElementById("p_mid_input")
    .setAttribute("placeholder", `${idea_arr[random]}`);
};
...
const add = () => {
  ...
  d.innerHTML = `<h2 style="color:#00A5EC;margin:5px" onclick="open_list(event)" id="item_title${
    ...
    arr[arr.length - 1]
  }"> </div><div id="add_new" style="position:absolute;top:512px;"> <span class="material-symbols-rounded" style="color: #00A5EC; font-size: 40px;" onclick="add_item(event)" id="add_btn_box_${
    arr[arr.length - 1]
...
function add_item(event) {
  ...
  const random = Math.floor(Math.random() * idea_arr.length);
  document.getElementById("p2_mid_input").setAttribute("placeholder", `${idea_arr[random]}`);
...
const open_list = (event) => {
  ...
  // arr4 = [];
  // var it = par.children[2];
  // if (it.childElementCount != 0) {
  //   for (var j = 0; j < it.childElementCount; j++) {
  //     var val1=it.children[j]
  //     window["li" + j] = val1;
  //     arr4.push(window["li" + j]);
  //   }
  // }
  ...
  // if (it.childElementCount != 0) {
  //   for (var n = 0; n < it.childElementCount; n++) {
  //     ndiv.children[2].appendChild(arr4[n]);
  //   }
  // }
...
//     for(var i=0;i<document.getElementById('container').childElementCount;i++){
//         console.log(document.getElementById('container').children[i]);
//         if(document.getElementById('container').children[i].id===boxId){
//             document.getElementById('container').children[i].style.visibility='visible';
//         }
//         else{
//             document.getElementById('container').children[i].style.visibility='none';
//         }
//     }
// }
// Go Back
